...
namespace FitnessProje.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Antrenörler", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Antrenörler_Hizmetler_HizmetlerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Randevular_Antrenörler_AntrenörId",
                        column: x => x.AntrenörId,
                        principalTable: "Antrenörler",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Antrenörler_HizmetlerId",
                table: "Antrenörler",
                column: "HizmetlerId");
